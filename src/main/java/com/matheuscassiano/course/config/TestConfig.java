...
import com.matheuscassiano.course.entities.OrderItem;
import com.matheuscassiano.course.entities.Payment;
...
import com.matheuscassiano.course.repositories.OrderItemRepository;
...
public class TestConfig implements CommandLineRunner {
	...
	public void run(String... args) throws Exception {
		...
		// associção entre objetos(usuario e pedido)
		...
		//para salvar um objeto dependende em uma relação 1 a 1
		//eu associo o pedido 1 com o pagamento pay 1 e mando salvar novamente o pedido e o jpa tratará de salvar o pagamento desse pedido
		o1.setPayment(pay1);
